...
export function GoogleAddressInput({
  ...
  return (
    <div className="relative">
      <MapPin className="absolute left-3 top-1/2 size-4 -translate-y-1/2 text-[var(--public-muted)]" />
      <Input
        ref={inputRef}
        value={value.address}
        ...
        className="h-11 border-[var(--public-input-border)] bg-[var(--public-input-bg)] pl-9 text-[var(--public-text)] placeholder:text-[var(--public-muted)] focus-visible:border-[var(--public-focus)] focus-visible:ring-[var(--public-focus)]/20"
      />
    </div>
  );
}
